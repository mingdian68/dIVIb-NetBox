...
async function handleRequest(request) {
  ...
  const sites = [
    ...
    { url: "https://www.gitlabip.xyz/Alvin9999/pac2/master/xray/2/config.json", type: "xray"},
    ...
    { url: "https://fastly.jsdelivr.net/gh/Alvin9999/pac2@latest/clash/2/config.json", type: "xray"},
